...
const EventCard = ({ dept }) => {
  ...
  return (
    <div
      className="element-fade-cards w-80 group relative px-4 py-8 flex flex-col items-center justify-between gap-4 rounded-2xl overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.6)] transition-transform duration-300 bg-[linear-gradient(145deg,_#0a0a0a,_#1c1c1c,_#3e3e3e,_#1c1c1c,_#0a0a0a)] border border-gray-800"
        ...
        <div className="flex flex-col justify-center items-center gap-4 z-10 px-4 w-full max-w-sm mx-auto">
          ...
          <div className="relative w-full min-h-[6rem] flex items-center justify-center">
            ...
            <img
              ...
              className="absolute  w-32 h-32 scale-110 group-hover:scale-130  opacity-50 blur-xs md:blur-none group-hover:blur-xs object-contain transition-all duration-300 group-hover:opacity-40 md:opacity-100"
            />
