...
export default function EventDescription({eventName,eventDescription,eligibleParticipants,venue}) {
  return (
    ...
    <div className='my-8 md:my-16'>
        ...
        <p className='manrope-paragraph text-justify text-sm md:text-base'>{eventDescription}</p>
    </div>
    ...
    <div  className='my-8 md:my-16'>
        ...
        <p className='manrope-paragraph text-center text-sm md:text-base'>{eligibleParticipants}</p>
    </div>
    <hr className="h-[1px]  w-full  my-10 mx-10 bg-gradient-to-r from-gray-300 via-gray-400 to-gray-300 border-0" />
    ...
    <div className='my-8 md:my-16'>
        ...
        <p className='manrope-paragraph  text-center text-sm md:text-base'>{venue}</p>
    </div>
